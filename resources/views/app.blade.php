...
<head>
  ...
  <!--Admin LTE sweetalert css link -->
  <link rel="stylesheet" href="{{asset('public/plugins/toastr-master/build/toastr.css')}}">
  <link rel="stylesheet" href="{{asset('public/plugins/bootstrap-sweetalert-master/bootstrap-sweetalert-master/dist/sweetalert.css')}}">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Online News Portal</span>
    </a>
...
<!--Admin LTE sweetalert js link -->
<script src="{{asset('public/plugins/dist/js/demo.js')}}"></script>
<script src="{{asset('public/plugins/toastr-master/build/toastr.min.js')}}"></script>
<script src="{{asset('public/plugins/bootstrap-sweetalert-master/bootstrap-sweetalert-master/dist/sweetalert.min.js')}}"></script>
<!-- data table-->
...
<!--Sweetalert notification js -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.min.js" integrity="sha512-7VTiy9AhpazBeKQAlhaLRUk+kAMAb8oczljuyJHPsVPWox/QIXDFOnT9DUk1UC8EbnHKRdQowT7sOBe7LAjajQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<!--Sweetalert notification jquery -->
