            ...
            <div class="content-header">
                    <div class="container-fluid">
                        ...
                        <div class="col-sm-6">
                            ...
                            <li class="breadcrumb-item active">Video Gallery Page</li>
                            </ol>
                        </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                ...
                <section class="content">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Video Gallery Page</h3>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{route('store.video')}}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            <label for="exampleInputPassword1" class="form-label">Embeded_Code</label>
                                            <input type="text" class="form-control" name="embeded_code" id="bangla" >
