            ...
            <div class="content-header">
                    <div class="container-fluid">
                        ...
                        <div class="col-sm-6">
                            ...
                            <li class="breadcrumb-item active">Subdistricts page</li>
                            </ol>
                        </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                ...
                <section class="content">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Subdistricts Table</h3>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Insert Sub-District</h4>
                                ...
                                <div class="modal-body">
                                    <form action="{{route('store.subdistrict')}}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('subdistrict_en')is-invalid @enderror" id="english" name="subdistrict_en" aria-describedby="emailHelp" placholder="name " > 
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('subdistrict_bn')is-invalid @enderror" name="subdistrict_bn" id="bangla">
