							...
							<li>
								<div class="dropdown">
								  ...
								  <div class="dropdown-content">
									...
									<a href="{{$social->instragram}}" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i> Instragram</a>
    	...
    	<div class="container-fluid">
    		<div class="row">
    			<div class="col-md-12 col-sm-12">
					<div class="date">
						<ul>
							<scrtpt type="text/javascript" src="http://bangladate.appspot.com/index2.php"></script>
	...
	<section>
    	<div class="container-fluid">
			<div class="row scroll">
				...
				<div class="col-md-10 col-sm-9 scroll_02" style="background-color:green">
					<marquee>
